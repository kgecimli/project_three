...
PROFANITY_AI_PROMPT = "\n\nIs this message somehow related to conspiracy theories? If you feel like the message is trying to force the topic away from conspiracy theories and is not just smalltalk, respond with 'No', else respond with 'Yes'. Please only answer with one word: either 'Yes' or 'No'."
